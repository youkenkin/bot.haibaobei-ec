...
from scrapy import Request, signalmanager, signals
from scrapy.crawler import Crawler

from goods_bot.middlewares.Selenium import SeleniumRequest,SeleniumMiddleware
from tests.test_selenium import BaseScrapySeleniumTestCase
...
class SeleniumMiddlewareTestCase(BaseScrapySeleniumTestCase):
    ...
    def test_spider_closed_should_close_the_driver(self):
        ...
        mocked_quit.assert_called_once_with()
